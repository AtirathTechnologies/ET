      ...
      return (
        <section id="products" className="bg-dark min-h-screen">
            <div className="w-full m-0 p-0">
                {/* Back to Button - Added above the main content */}
                <div className="ml-6 mt-4">
                    <button
                        onClick={goBackToProducts}
                        className="flex items-center gap-2 text-secondary hover:text-accent transition-colors font-semibold text-lg mb-4"
                    >
                ...
                <div className="flex m-0 p-0">
                    {/* Sidebar with larger left gap */}
                    <div className="ml-6"> {/* Increased to ml-6 for larger left gap */}
                        <Sidebar
                    ...
                    <div className="flex-1 p-4 min-h-screen ml-6 mr-6"> {/* Increased to ml-6 and mr-6 */}
                        {currentSearchTerm && (
